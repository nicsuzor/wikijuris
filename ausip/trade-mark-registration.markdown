...
The first stage is completing the application which can be filled out either online or by paper. The application is in a prescribed form. [^REPLACEMETMAs27ENDREPLACE]
[^REPLACEMETMAs27ENDREPLACE]: //TMA// s 27
...
The final stage is registration. The registrar must register the trade mark. [^REPLACEMETMAs68ENDREPLACE]
[^REPLACEMETMAs68ENDREPLACE]: //TMA// s 68
...
Registered trade marks are registered for a period of 10 years initially and can be renewed indefinitely after this time.[^REPLACEMETMAs723ENDREPLACE]
[^REPLACEMETMAs723ENDREPLACE]: //TMA// s 72(3) 
...
A person may apply for registration if the person claims to be the *owner* of the trade mark. [^REPLACEMETMAs271ENDREPLACE]
[^REPLACEMETMAs271ENDREPLACE]: //TMA// s 27(1) 
...
These include:
  ...
  * The applicant is not the owner of the trade mark; [^REPLACEMETMAs271ENDREPLACE]
[^REPLACEMETMAs271ENDREPLACE]: //TMA// s 27(1) 

  * The trade mark contains a prescribed sign; [^REPLACEMETMAs39ENDREPLACE]
[^REPLACEMETMAs39ENDREPLACE]: //TMA// s 39

  * The trade mark cannot be represented graphically; [^REPLACEMETMAs40ENDREPLACE]
[^REPLACEMETMAs40ENDREPLACE]: //TMA// s 40

  * The trade mark is not capable of distinguishing; [^REPLACEMETMAs41ENDREPLACE]
[^REPLACEMETMAs41ENDREPLACE]: //TMA// s 41

  * The trade mark is scandalous or contrary to law; [^REPLACEMETMAs42ENDREPLACE]
[^REPLACEMETMAs42ENDREPLACE]: //TMA// s 42

  * The trade mark is likely to deceive or cause confusion; and [^REPLACEMETMAs43ENDREPLACE]
[^REPLACEMETMAs43ENDREPLACE]: //TMA// s 43

  * The trade mark is substantially identical or deceptively similar to a registered trade mark. [^REPLACEMETMAs44ENDREPLACE]
[^REPLACEMETMAs44ENDREPLACE]: //TMA// s 44



There is a presumption of registrability.[^REPLACEMETMAs33ENDREPLACE]
[^REPLACEMETMAs33ENDREPLACE]: //TMA// s 33


### The Applicant is Not the Owner of the Trade Mark

The application for registration may be refused on the basis that the applicant is not the owner of the trade mark. [^REPLACEMETMAs33s271ENDREPLACE]
[^REPLACEMETMAs33s271ENDREPLACE]: //TMA// s 33, s 27(1) 


### Contains a Prescribed Sign

A trade mark cannot be registered if it contains or consists of a prescribed sign – as set out in Schedule 2 of the [Trade Mark Regulations 1995](https://www.legislation.gov.au/Details/F2018C00773). [^REPLACEMETMAs39ENDREPLACE]
[^REPLACEMETMAs39ENDREPLACE]: //TMA// s 39
...
A trade mark cannot be registered where it cannot be described in writing and/or drawing. A trade mark must not be solely graphically represented. [^REPLACEMETMAs40ENDREPLACE]
[^REPLACEMETMAs40ENDREPLACE]: //TMA// s 40
...
An application for registration must be rejected if the trade mark is not capable of distinguishing the applicant’s goods or services from the goods or services of other persons. [^REPLACEMETMAs411ENDREPLACE]
[^REPLACEMETMAs411ENDREPLACE]: //TMA// s 41(1) 
...
* The word 'Whopper': *[Burger King Corp v Registrar of Trade Marks](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/HCA/1973/15.html)*; [^REPLACEME1973HCA15ENDREPLACE]
[^REPLACEME1973HCA15ENDREPLACE]: [1973] HCA 15
 [^REPLACEMEhttpwwwaustliieduauaucasescthHCA197315htmlENDREPLACE]
[^REPLACEMEhttpwwwaustliieduauaucasescthHCA197315htmlENDREPLACE]: http://www.austlii.edu.au/au/cases/cth/HCA/1973/15.html


* The words 'Cranberry Classic': *[Ocean Spray Cranberries v Registrar of Trade Marks](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/FCA/2000/177.html)*; [^REPLACEME2000FCA177ENDREPLACE]
[^REPLACEME2000FCA177ENDREPLACE]: [2000] FCA 177


* The word 'Oregon' with device: *[Blount Inc v Registrar of Trade Marks](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/FCA/1998/440.html)*. [^REPLACEME1998FCA440ENDREPLACE]
[^REPLACEME1998FCA440ENDREPLACE]: [1998] FCA 440
...
In *Ocean Spray Cranberries v Registrar of Trade Marks*, [^REPLACEME2000FCA177ENDREPLACE]
[^REPLACEME2000FCA177ENDREPLACE]: [2000] FCA 177
...
__//Gazal Apparel Pty Ltd v Fine Lines Extraordinary Apparel Pty Ltd//[^REPLACEME1999ATMO90ENDREPLACE]
[^REPLACEME1999ATMO90ENDREPLACE]: [1999] ATMO 90
__

In *Gazal Apparel Pty Ltd v Fine Lines Extraordinary Apparel Pty Ltd*, [^REPLACEME1999ATMO90ENDREPLACE]
[^REPLACEME1999ATMO90ENDREPLACE]: [1999] ATMO 90
...
__//Koninklijke Philips Electronics NV v Remington Products Australia Pty Ltd//[^REPLACEME1999FCA816ENDREPLACE]
[^REPLACEME1999FCA816ENDREPLACE]: [1999] FCA 816
__

In *Koninklijke Philips Electronics NV v Remington Products Australia Pty Ltd*, [^REPLACEME1999FCA816ENDREPLACE]
[^REPLACEME1999FCA816ENDREPLACE]: [1999] FCA 816
...
In *[Chocolaterie Guylian N.V. v Registrar of Trade Marks](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/FCA/2009/891.html)*, [^REPLACEME2009FCA891ENDREPLACE]
[^REPLACEME2009FCA891ENDREPLACE]: [2009] FCA 891
...
__//Kenman Kandy Australia Pty Ltd v Registrar of Trade Marks//[^REPLACEME2002FCAFC273ENDREPLACE]
[^REPLACEME2002FCAFC273ENDREPLACE]: [2002] FCAFC 273
__

In *[Kenman Kandy Australia Pty Ltd v Registrar of Trade Marks](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/FCAFC/2002/273.html)*, [^REPLACEME2002FCAFC273ENDREPLACE]
[^REPLACEME2002FCAFC273ENDREPLACE]: [2002] FCAFC 273
...
__//Philmac Pty Limited v The Registrar of Trade Marks//[^REPLACEME2002FCA1551ENDREPLACE]
[^REPLACEME2002FCA1551ENDREPLACE]: [2002] FCA 1551
__

In *Philmac Pty Limited v The Registrar of Trade Marks*, [^REPLACEME2002FCA1551ENDREPLACE]
[^REPLACEME2002FCA1551ENDREPLACE]: [2002] FCA 1551
 a terracotta shade on plastic pipes and pipe fittings could be registered as a trade mark as the colour had no functional purpose. In contrast, in *Smith Kline and French Laboratories (Australia) Ltd v Registrar of Trade Marks*, [^REPLACEME1967HCA42ENDREPLACE]
...
__//Woolworths Limited v BP p.l.c.// [^REPLACEME2013ATMO61ENDREPLACE]
[^REPLACEME2013ATMO61ENDREPLACE]: [2013] ATMO 61
__

In *Woolworths Limited v BP p.l.c.*, [^REPLACEME2013ATMO61ENDREPLACE]
[^REPLACEME2013ATMO61ENDREPLACE]: [2013] ATMO 61
...
A trade mark will be deemed scandalous if it is found to cause a significant degree of disgrace, shame or outrage.[^REPLACEMETMAs42aENDREPLACE]
[^REPLACEMETMAs42aENDREPLACE]: //TMA// s 42(a) 
 [^REPLACEMESeeforexampleNuckinFutsTradeMarkApplicationNo140813424February2011andPommiebasherPeterHanlon2011ATMO45ENDREPLACE]
[^REPLACEMESeeforexampleNuckinFutsTradeMarkApplicationNo140813424February2011andPommiebasherPeterHanlon2011ATMO45ENDREPLACE]: See for example Nuckin Futs *Trade Mark Application No. 1408134* (24 February 2011) and Pommiebasher (*Peter Hanlon* [2011] ATMO 45



### Connotation Likely to Deceive or Cause Confusion

An application for registration must be rejected if, because of some *connotation*  the use of the trade mark (or a sign contained in the trade mark), in relation to those goods/services, would be *likely to deceive or cause confusion*.[^REPLACEMETMAs43ENDREPLACE]
[^REPLACEMETMAs43ENDREPLACE]: //TMA// s 43
...
__//Scotch Whisky Association v De Witt// [^REPLACEME2007FCA1649ENDREPLACE]
[^REPLACEME2007FCA1649ENDREPLACE]: [2007] FCA 1649
__

In *[Scotch Whisky Association v De Witt](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/FCA/2007/1649.html)*, [^REPLACEME2007FCA1649ENDREPLACE]
[^REPLACEME2007FCA1649ENDREPLACE]: [2007] FCA 1649
...
An application must be rejected if the trade mark is *substantially identical* with or *deceptively similar* to an existing trade mark.[^REPLACEMETMAs44ENDREPLACE]
[^REPLACEMETMAs44ENDREPLACE]: //TMA// s 44
 This applies:
...
If the public would not expect the same business to supply both the goods/services, then the two are unlikely to be considered closely related. In *[Registrar of Trade Marks v Woolworths Ltd](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/FCA/1999/1020.html)*, [^REPLACEME1999FCA1020ENDREPLACE]
[^REPLACEME1999FCA1020ENDREPLACE]: [1999] FCA 1020
...
__//Shell Co (Aust) Ltd v Esso Standard Oil (Aust) Ltd//[^REPLACEME1963HCA66ENDREPLACE]
[^REPLACEME1963HCA66ENDREPLACE]: [1963] HCA 66]
__

Windeyer J in *[Shell Co (Aust) Ltd v Esso Standard Oil (Aust) Ltd](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/HCA/1963/66.html)*, [^REPLACEME1963HCA66ENDREPLACE]
[^REPLACEME1963HCA66ENDREPLACE]: [1963] HCA 66]
 observed that:
...
Substantial identity cannot be established simply on the basis that one trade mark is contained within another trade mark. For example,  'St Agnes Liquor Store' was held not to be substantially identical to 'St Agnes'.[^REPLACEMEAngovesPtyLtdvJohnson198243ALR349ENDREPLACE]
[^REPLACEMEAngovesPtyLtdvJohnson198243ALR349ENDREPLACE]: *Angoves Pty Ltd v Johnson* (1982) 43 ALR 349


__//Coca Cola Co v All-Fect Distributors Ltd//[^REPLACEME199996FCR107ENDREPLACE]
[^REPLACEME199996FCR107ENDREPLACE]:  (1999) 96 FCR 107
__

In *Coca Cola Co v All-Fect Distributors Ltd*, [^REPLACEME199996FCR107ENDREPLACE]
[^REPLACEME199996FCR107ENDREPLACE]:  (1999) 96 FCR 107
...
__//Woolworths v Register of Trade Marks//[^REPLACEME1999FCAFC1020ENDREPLACE]
[^REPLACEME1999FCAFC1020ENDREPLACE]: [1999] FCAFC 1020
__

In *Woolworths v Register of Trade Marks*, [^REPLACEME1999FCAFC1020ENDREPLACE]
[^REPLACEME1999FCAFC1020ENDREPLACE]: [1999] FCAFC 1020
...
__//Torpedoes Sportswear Pty Limited v Thorpedo Enterprises Pty Limited//[^REPLACEME2003FCA901ENDREPLACE]
[^REPLACEME2003FCA901ENDREPLACE]: [2003] FCA 901
__

In *[Torpedoes Sportswear Pty Limited v Thorpedo Enterprises Pty Limited](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/FCA/2003/901.html)*, [^REPLACEME2003FCA901ENDREPLACE]
[^REPLACEME2003FCA901ENDREPLACE]: [2003] FCA 901
...
A trade mark is taken to be deceptively similar to another trade  mark if it so nearly resembles that other trade mark that it is *likely to deceive or cause confusion*. [^REPLACEMETMAs10ENDREPLACE]
[^REPLACEMETMAs10ENDREPLACE]: //TMA// s 10
 Windeyer J in *Shell Co (Aust) Ltd v Esso Standard Oil (Aust) Ltd* [^REPLACEME1963HCA66ENDREPLACE]
[^REPLACEME1963HCA66ENDREPLACE]: [1963] HCA 66
 observed:
...
__//Southern Cross Refrigeration Co v Toowoomba Foundry Pty Ltd//[^REPLACEME1954HCA82ENDREPLACE]
[^REPLACEME1954HCA82ENDREPLACE]: [1954] HCA 82
__

In *[Southern Cross Refrigeration Co v Toowoomba Foundry Pty Ltd](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/HCA/1954/82.html)*, [^REPLACEME1954HCA82ENDREPLACE]
[^REPLACEME1954HCA82ENDREPLACE]: [1954] HCA 82
...
__//Berlei Hestia Industries v the Bali Co, Inc//[^REPLACEME1973HCA43ENDREPLACE]
[^REPLACEME1973HCA43ENDREPLACE]: [1973] HCA 43
__

In *[Berlei Hestia Industries v the Bali Co, Inc](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/HCA/1973/43.html)*, [^REPLACEME1973HCA43ENDREPLACE]
[^REPLACEME1973HCA43ENDREPLACE]: [1973] HCA 43
...
__//Campomar Sociedad Limited v Nike International Limited//[^REPLACEME2000HCA12ENDREPLACE]
[^REPLACEME2000HCA12ENDREPLACE]: [2000] HCA 12
__

In *[Campomar Sociedad Limited v Nike International Limited](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/HCA/2000/12.html)*, [^REPLACEME2000HCA12ENDREPLACE]
[^REPLACEME2000HCA12ENDREPLACE]: [2000] HCA 12
...
__//Crazy Ron's v Mobileworld//[^REPLACEME2004FCAFC196ENDREPLACE]
[^REPLACEME2004FCAFC196ENDREPLACE]: [2004] FCAFC 196
__

*[Crazy Ron's v Mobileworld](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/FCAFC/2004/196.html)*, [^REPLACEME2004FCAFC196ENDREPLACE]
[^REPLACEME2004FCAFC196ENDREPLACE]: [2004] FCAFC 196
...
__//Wingate Marketing v Levi Strauss//[^REPLACEME1994FCA1001ENDREPLACE]
[^REPLACEME1994FCA1001ENDREPLACE]: [1994] FCA 1001
__

In *[Wingate Marketing v Levi Strauss](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/FCA/1994/1001.html)*, [^REPLACEME1994FCA1001ENDREPLACE]
[^REPLACEME1994FCA1001ENDREPLACE]: [1994] FCA 1001
...
__//CA Henschke & Co v Rosemount Estates Pty Ltd//[^REPLACEME2000FCA1539ENDREPLACE]
[^REPLACEME2000FCA1539ENDREPLACE]: [2000] FCA 1539
__

In *[CA Henschke & Co v Rosemount Estates Pty Ltd](http://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/FCA/2000/1539.html)*, [^REPLACEME2000FCA1539ENDREPLACE]
[^REPLACEME2000FCA1539ENDREPLACE]: [2000] FCA 1539
 compared the applicants trade mark 'Hill of Grace' with the respondents' 'Hill of Gold' and concluded that there was no infringement. The judgement applied the common law test for deceptive similarity by considering the impression an ordinary person with ordinary recollection would derive from the marks. The case turned on the finding of a distinct character of the metaphorical connotations of the marks. Notably, the case established that evidence as to reputation of the initial mark was not relevant to proving infringement by deceptive similarity where the initial mark is not notoriously so ubiquitous that consumers must be familiar with it. [^REPLACEMEDistinguishingWoolworthsvRegisterofTradeMarks1999FCAFC1020andCocaColaCovAllFectDistributorsLtd199996FCR107ENDREPLACE]
[^REPLACEMEDistinguishingWoolworthsvRegisterofTradeMarks1999FCAFC1020andCocaColaCovAllFectDistributorsLtd199996FCR107ENDREPLACE]: Distinguishing *Woolworths v Register of Trade Marks* [1999] FCAFC 1020 and *Coca Cola Co v All-Fect Distributors Ltd* (1999) 96 FCR 107
...
A trade mark can be opposed by an interested third party within two months of the trade mark being advertised for opposition purposes. [^REPLACEMETMAs52ENDREPLACE]
[^REPLACEMETMAs52ENDREPLACE]: //TMA// s 52
 The grounds on which a trade mark can be rejected include:

  * All grounds on which an application may be rejected, except graphical representation; [^REPLACEMETMAs57ENDREPLACE]
[^REPLACEMETMAs57ENDREPLACE]: //TMA// s 57

  * The applicant is not the owner of the trade mark; [^REPLACEMETMAs58ENDREPLACE]
[^REPLACEMETMAs58ENDREPLACE]: //TMA// s 58

  * The applicant is not a prior continuous user of the trade mark; [^REPLACEMETMAss58A444ENDREPLACE]
[^REPLACEMETMAss58A444ENDREPLACE]: //TMA// ss 58A, 44(4) 

  * The applicant is not intending to use the trade mark; [^REPLACEMETMAs59ENDREPLACE]
[^REPLACEMETMAs59ENDREPLACE]: //TMA// s 59

  * The trade mark has acquired reputation and the other trade mark would deceive or cause confusion; [^REPLACEMETMAs60ENDREPLACE]
[^REPLACEMETMAs60ENDREPLACE]: //TMA// s 60

  * The trade mark contains or consists of false geographical indication; [^REPLACEMETMAs61ENDREPLACE]
[^REPLACEMETMAs61ENDREPLACE]: //TMA// s 61

  * The application was defective; [^REPLACEMETMAs62ENDREPLACE]
[^REPLACEMETMAs62ENDREPLACE]: //TMA// s 62
 and
  * The application was made in bad faith. [^REPLACEMETMAs62AENDREPLACE]
[^REPLACEMETMAs62AENDREPLACE]: //TMA// s 62A
